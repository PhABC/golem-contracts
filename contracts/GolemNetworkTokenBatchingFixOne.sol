...
/// GolemNetworkTokenBatchingFixOne can be treated as an upgraded GolemNetworkToken.
...
contract GolemNetworkTokenBatchingFixOne is TokenProxy {
    ...
    function GolemNetworkTokenBatchingFixOne(ERC20Basic _gntToken) TokenProxy(_gntToken) public {
    }
